...
<script type="text/javascript" src="js/interfade_start.js"></script>
<noscript>
...
<table align="center" width="1010px" border="0">
  ...
  <tr>
    ...
    <td valign="top"><h3 align="center" class="p_style" style="margin-bottom:5px; color:#000;"><?php echo $index_top_last; ?></h3>
    <?php
	if($lang == 'rus')
	{
		$ltd_result = mysql_query("SELECT sh_name,descr_offer,city,b_def,defcat,from_date_offer,till_date_offer FROM ltd_page_rus WHERE activation = '1' ORDER BY id DESC LIMIT 3");
	}
	else
	{
		$ltd_result = mysql_query("SELECT sh_name,descr_offer,city,b_def,defcat,from_date_offer,till_date_offer FROM ltd_page_lat WHERE activation = '1' ORDER BY id DESC LIMIT 3");
	}
	...
	?>
        <table class="table_style" style="margin-bottom:5px;" border="0" cellpadding="0" cellspacing="0"><tr>
        <td><?php 
		...
		if(mysql_num_rows($gallery_resutl)>0)
		{
        ...
        <td>
            ...
            <tr>
            <td><p><?php echo mb_convert_encoding($offer, "utf8", "utf8")." ..."; ?></p></td>
            </tr>
            </table>
        </td>
       	...
       	<?php if(!empty($gallery_row['photo_1_s']) || !empty($gallery_row['photo_2_s']) || !empty($gallery_row['photo_3_s']) || !empty($gallery_row['photo_4_s']))
		{
         ?>   
            ...
            <?php if(!empty($gallery_row['photo_1_s']))
                {
					?>
						<img width="70px" height="70px" style="position:relative; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px;" src="<?php echo $gallery_row['photo_1_s']; ?>" alt="<?php echo $sh_name; ?>" />
                    <?php
				}
				...
				{
					?>
						<img width="70px" height="70px" style="position:relative; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px;" src="<?php echo $gallery_row['photo_2_s']; ?>" alt="<?php echo $sh_name; ?>" />
                    <?php
				}		
				...
				{
					?>
						<img width="70px" height="70px" style="position:relative; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px;" src="<?php echo $gallery_row['photo_3_s']; ?>" alt="<?php echo $sh_name; ?>" />
                    <?php
				}	
				...
				{
					?>		
						<img width="70px" height="70px" style="position:relative; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px;" src="<?php echo $gallery_row['photo_4_s']; ?>" alt="<?php echo $sh_name; ?>" />
                    <?php
				}
				?>
				</div>
	...
	//vivod topa
	$result_top_select = mysql_query("SELECT sh_name,SUM(votes) FROM top_index GROUP BY sh_name ORDER BY votes DESC LIMIT 3");
	if(mysql_num_rows($result_top_select)>0)
	{
		?>
		<h3 align="center" class="p_style" style="margin-bottom:5px; margin-top:15px; color:#000;"><?php echo $index_top_views; ?></h3>
		<?php
		while($row_top_shname = mysql_fetch_array($result_top_select))
		{
			...
			if($lang == 'rus')
			{
				$result_select_top_ltd = mysql_query("SELECT sh_name,descr_offer,city,b_def,defcat,from_date_offer,till_date_offer FROM ltd_page_rus WHERE activation = '1' AND sh_name = '$top_shname' ORDER BY id DESC");
			}
			else
			{
				$result_select_top_ltd = mysql_query("SELECT sh_name,descr_offer,city,b_def,defcat,from_date_offer,till_date_offer FROM ltd_page_lat WHERE activation = '1' AND sh_name = '$top_shname' ORDER BY id DESC");
			}
			...
			while($row_select_top_ltd = mysql_fetch_array($result_select_top_ltd))
			{
				...
				?>
				<table class="table_style" style="margin-bottom:5px;" cellpadding="0" cellspacing="0" border="0">
				<tr>
				<td>
                <?php
				...
				if(mysql_num_rows($result_galerry_top)>0)
				{
                ...
                <td>
                        ...
                        <tr>
                        <td><p><?php echo mb_convert_encoding($offer_top, "utf8", "utf8")." ..."; ?></p></td>
                        </tr>
                        </table>
                </td>
                <td width="80px" valign="middle">
				<?php if(!empty($row_gallery_top['photo_1_s']) || !empty($row_gallery_top['photo_2_s']) || !empty($row_gallery_top['photo_3_s']) || !empty($row_gallery_top['photo_4_s']))
                {
                 ?>   
                    ...
                    <?php if(!empty($row_gallery_top['photo_1_s']))
                        {
                            ?>
                                <img width="70px" height="70px" style="position:relative; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px;" src="<?php echo $row_gallery_top['photo_1_s']; ?>" alt="<?php echo $sh_name_top; ?>" />
                            <?php
                        }
                        ...
                        {
                            ?>
                                <img width="70px" height="70px" style="position:relative; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px;" src="<?php echo $row_gallery_top['photo_2_s']; ?>" alt="<?php echo $sh_name_top; ?>" />
                            <?php
                        }		
                        ...
                        {
                            ?>
                                <img width="70px" height="70px" style="position:relative; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px;" src="<?php echo $row_gallery_top['photo_3_s']; ?>" alt="<?php echo $sh_name_top; ?>" />
                            <?php
                        }	
                        ...
                        {
                            ?>		
                                <img width="70px" height="70px" style="position:relative; -moz-border-radius:10px; -webkit-border-radius:10px; border-radius:10px;" src="<?php echo $row_gallery_top['photo_4_s']; ?>" alt="<?php echo $sh_name_top; ?>" />
                            <?php
                        }
                        ?>
                        </div>
    ...
    <td valign="top" width="105px"><?php echo $promoright." ".$promoleft; ?></td>
  </tr>
  </table>
  </td>
  </tr>
