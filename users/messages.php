...
<noscript>
<meta http-equiv="refresh" content="0; url= messages_nosrc.php?lang=<?php echo $lang; ?>"/>
</noscript>
</head>
<body>
...
<td>
        ...
        if(mysql_num_rows($result_message)>0)
		{
			...
			?>
			<table align="center" class="profile_table" width="100%" border="1" cellpadding="5" cellspacing="0">
            <tr>
			...
			while($row_message = mysql_fetch_array($result_message))
			{
				...
				{	
					...
					<td align="center">
                    <p><a href="messages.php?lang=<?php echo $lang; ?>" onClick="window.open('messages_r.php?lang=<?php echo $lang;?>&id=<?php echo $row_message['id']; ?>&act=r', 'newWin', 'Toolbar=0, Location=0, Directories=0, Status=0, Menubar=0, Scrollbars=1, Resizable=0, Copyhistory=1, Width=600, Height=400')"><strong><?php echo $messages_read; ?></strong></a></p>
				...
				else
				{
					...
					<td align="center"><p><a href="messages.php?lang=<?php echo $lang; ?>" onClick="window.open('messages_r.php?lang=<?php echo $lang;?>&id=<?php echo $row_message['id']; ?>&act=r', 'newWin', 'Toolbar=0, Location=0, Directories=0, Status=0, Menubar=0, Scrollbars=1, Resizable=0, Copyhistory=1, Width=600, Height=400')"><strong><?php echo $messages_read; ?></strong></a></p>
                    <p><a href='messages.php?lang=<?php echo $lang; ?>&id=<?php echo $row_message['id']; ?>&act=d'><strong><?php echo $messages_delet; ?></strong></a></p>
                    </td>
					</tr>
					<?php
