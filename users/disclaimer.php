...
if ($lang == "rus")
$result = mysql_query ("SELECT * FROM common_text_rus WHERE page='disclaimer'",$db); 
else
$result = mysql_query ("SELECT * FROM common_text_lat WHERE page='disclaimer'",$db);
?>
<?php if (!$result)
{
...
<table align="center" width="1010" border="0">
  ...
  <tr>
    ...
    <td valign="top"><div id="textwrap"><?php echo $myrow['text']; ?></div></td>
    <td valign="top" width="75px"></td>
  </tr>
</table></div>
</td>
